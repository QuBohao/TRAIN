...
def construct_and_train_graph(observations, actions, rewards, args):
    ...
    graph_training_time=time.perf_counter()
    # start=datetime.datetime.now()
    print("Graph_training_time:",graph_training_time - start)
    ...
    reward_propagation_time=time.perf_counter()
    # start=datetime.datetime.now()
    print("Reward_propagation_time:",reward_propagation_time - graph_training_time)
